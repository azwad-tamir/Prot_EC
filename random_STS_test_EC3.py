...
accuracy_matrics_Random_EC3_STS_list = []
...
EC2_STS_list = [0,1,3,4,5,7,8,9,11,12,13,14,15,16,17]
EC1_STS_list = [0,1,3,4,5,7,8,9,11,12,13,15,16,17,19]

for EC3_STS_models in range(14,-1,-1):
    ########################################################################################################################
    ########################################################################################################################
    #                                                    EC3_Random_test                                                   #
    ########################################################################################################################
    ...
    Accuracy_matrics_EC1 = accuracy_matrics_Random_EC1_STS_list[EC1_STS_list[EC3_STS_models]]
    ...
    Accuracy_matrics_EC2 = accuracy_matrics_Random_EC2_STS_list[EC2_STS_list[EC3_STS_models]]
    ...
    for fold in fold_range:
        ...
        model_path = "./models_STS_EC3_" + str(EC3_STS_models)
        temp_extension = glob.glob(model_path + '/*')
        print("EC3_STS_model: ", model_path)
        print("Fractions: ", Fractions_EC3[EC3_STS_models])
        ...
        print("Accuracy: ", accuracy_eval_EC3)
        accuracy_matrics_Random_EC3_STS = [Fractions_EC3[EC3_STS_models], all_predictions_eval_EC3, all_labels_eval_EC3,
                                           all_logits_eval_EC3, accuracy_eval_EC3]

        accuracy_matrics_Random_EC3_STS_list.append(accuracy_matrics_Random_EC3_STS)

with open('./Accuracy_matrics_random_EC3_STS.pkl', 'wb') as f:
    pickle.dump(accuracy_matrics_Random_EC3_STS_list, f)

for i in range(0,len(accuracy_matrics_Random_EC3_STS_list)):
    print("Fractions: ", accuracy_matrics_Random_EC3_STS_list[i][0])
    print("Accuracies: ", accuracy_matrics_Random_EC3_STS_list[i][4])