...
# for i in range(8,15):
#     Fractions_old.append(Fractions[i])
...
STS_iter_list = [13,12,11,10,9,8]
########################################################################################################################
# Old_STS = [0.85, 0.7224, 0.6141, 0.5220, 0.4437, 0.3771, 0.3205, 0.2724, 0.2316, 0.1968] 1 to 10
# New_STS = [0.178252, 0.1426020124, 0.11408064196, 0.079853061, 0.047909900, 0.023952530, 0.009578108] starting from 8
for STS_iter in STS_iter_list:
    ...
    for fold in fold_range:
        ...
        save_dir = 'models_STS_EC2_new_' + str(STS_iter) + '/' + timestr + '/'
