...
for i in range(0,20):
    if i <12:
        ...
        text_train, text_test, labels_train, labels_test = train_test_split(text_train_list[i], labels_train_list[i],
                                                                    stratify=labels_train_list[i], test_size=(15+n*5)/100)
        n+=1
...
####################################################
# for STS_iter in range(0,12):
for STS_iter in range(20, 11,-1):
    print("###########################################################################################################")
    print("###########################################################################################################")
    ...
    for fold in fold_range:
        ...
        save_dir = 'models_STS_EC1_' + str(STS_iter) + '/' + timestr + '/'
...
#         print("STS_iter number: ", STS_iter)
...
#         print(accuracy_eval)
#
#         accuracy_matrics_Random_EC1_EX = [all_predictions_train, all_labels_train, all_logits_train,
#                                           accuracy_train, all_predictions_eval, all_labels_eval,
#                                           all_logits_eval, accuracy_eval]
#
#         accuracy_scores_EC1_STS15.append(accuracy_matrics_Random_EC1_EX)
#
#
# with open('./Accuracy_matrics_random_EC1_STS15.pkl', 'wb') as f:
#     pickle.dump(accuracy_scores_EC1_STS15, f)